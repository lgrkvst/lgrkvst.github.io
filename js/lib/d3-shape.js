// https://d3js.org/d3-shape/ Version 1.0.4. Copyright 2017 Mike Bostock.
...
var step = (function custom(radius) {
...
var stepAfter = (function custom(radius) {

  function step(context) {
    return radius ? new Step(context, 0, radius) : new Step(context, 0, 0);
  }
...
var stepBefore = (function custom(radius) {

  function step(context) {
    return radius ? new Step(context, 1, radius) : new Step(context, 1, 0);
  }
